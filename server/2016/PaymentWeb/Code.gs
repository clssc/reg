/** @const {string} */
var PAYMENT_DOCID = '147vhzCtvZko6iI6jtHw5izex4D2zbfu1WYbExrOwLWc';
...
function mailConfirmation(email, familyNumber, amount, paymentId) {
  MailApp.sendEmail(
    email,
    'Westside Chinese School 2016-2017 Registration: Payment received',
    '',
    {
...
'for the school year 2016-2017. Your online payment was successful. ' +
'The school will start on September 10, 2016. We will email pertinent ' +
